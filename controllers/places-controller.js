...
const createPlace = async(req, res, next) => {
    ...
    const createdPlace = new Place({
        ...
        image: "https://projection-mapping.org/wp-content/uploads/2015/08/obscura-project-change-empire-state-building-designboom-02-818x512.jpg",
        creator,
    });
    ...
    try {
        ...
        const error = new HttpError("Creating place failed 2", 500);
        return next(error);
    }
...
const deletePlace = async(req, res, next) => {
    ...
    try {
        ...
        const error = new HttpError("Could not delete the place 2", 500);
        return next(error);
    }
